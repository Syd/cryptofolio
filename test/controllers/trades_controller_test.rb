...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post trades_url, params: { trade: { closed: @trade.closed, opened: @trade.opened, paid: @trade.paid, price: @trade.price, uuid: @trade.uuid } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { closed: @trade.closed, opened: @trade.opened, paid: @trade.paid, price: @trade.price, uuid: @trade.uuid } }
